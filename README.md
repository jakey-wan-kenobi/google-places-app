...
- Chrome blocks geolocation requests when serving your site from file://. So serve it over localhost. (http://stackoverflow.com/questions/5423938/html-5-geo-location-prompt-in-chrome)
